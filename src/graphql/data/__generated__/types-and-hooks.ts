...
// Additional exports for queries added after the last committed schema snapshot.
...
export type AssetActivityPartsFragment = {
  ...
  chain: Chain
  details: TransactionDetailsPartsFragment | SwapOrderDetailsPartsFragment | { __typename?: string; hash?: string; [key: string]: any }
  timestamp: Scalars['Int']
  type: ActivityType
  id?: Scalars['ID']
}
export type SwapOrderDetailsPartsFragment = { orderStatus: SwapOrderStatus; [key: string]: any }
export type TransactionDetailsPartsFragment = { [key: string]: any }
export type NftApprovalPartsFragment = { [key: string]: any }
export type NftApproveForAllPartsFragment = { [key: string]: any }
export type NftTransferPartsFragment = { [key: string]: any }
export type TokenApprovalPartsFragment = { [key: string]: any }
export type TokenAssetPartsFragment = { [key: string]: any }
export type TokenTransferPartsFragment = { [key: string]: any }

export type ActivityQueryVariables = Exact<{ account: Scalars['String'] }>
export type ActivityQuery = {
  __typename?: 'Query'
  portfolios?: Array<{
    assetActivities?: ReadonlyArray<AssetActivityPartsFragment>
  }>
}

export type PortfolioBalancesQueryVariables = Exact<{ ownerAddress: Scalars['String']; chains: readonly Chain[] | Chain[] | Chain }>
export type PortfolioBalancesQuery = {
  __typename?: 'Query'
  portfolios?: Array<{
    tokenBalances?: Array<TokenBalance> | null
    tokensTotalDenominatedValue?: { value?: number | null } | null
    tokensTotalDenominatedValueChange?: {
      absolute?: { value?: number | null } | null
      percentage?: { value?: number | null } | null
    } | null
  }>
}

export type TokenSpotPriceQueryVariables = Exact<{ chain: Chain; address?: InputMaybe<Scalars['String']> }>
export type TokenSpotPriceQuery = {
  __typename?: 'Query'
  token?: {
    address?: string | null
    chain: Chain
    project?: { markets?: Array<{ price?: { value: number } | null } | null> | null } | null
  } | null
}

export type UniswapPricesQueryVariables = Exact<{ contracts: Array<ContractInput> | ContractInput }>
...
export type NftActivityQueryVariables = Exact<{ filter?: InputMaybe<NftActivityFilterInput>; after?: InputMaybe<Scalars['String']>; first?: InputMaybe<Scalars['Int']> }>
export type NftActivityQuery = {
  __typename?: 'Query'
  nftActivity?: {
    edges?: Array<{ node: NftActivity }> | null
    pageInfo?: PageInfo
  } | null
}

export type NftUniversalRouterAddressQueryVariables = Exact<{ chain?: InputMaybe<Chain> }>
export type NftUniversalRouterAddressQuery = { __typename?: 'Query'; nftRoute?: { toAddress?: string } | null }
